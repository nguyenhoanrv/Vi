...
get_integer:
	...
	beq	$a1,0, check_positive_integer		# if $a1 = 0 => check_positive_integer 
...
power: 
	...
	addi	$s0,$0,0		#i = 0
for_power:
	beq	$s0,$t0,square	# if i= t0 Thoat khoi vong lap 
...
Error_message:
	...
	j	exit			# jump to exit
exit:	li	$v0,10			# service 10 is exit
# EXIT
